...
plt.legend(['Velocity', 'V_x', 'V_y', 'V_z']);

plt.xlabel('velocity')
plt.ylabel('Distribution')
plt.title('Histogram of the initial velocities');
#plt.title(r'$\mathrm{Histogram\ of\ IQ:}\ \mu=100,\ \sigma=15$')
plt.axis([-3, 3, 0, 1])
#plt.grid(True)
plt.savefig("initial_velo.png");
